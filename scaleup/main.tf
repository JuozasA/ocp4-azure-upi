...
resource "azurerm_virtual_machine" "worker" {
  ...
  location              = "${var.azure_region}"
  resource_group_name   = "${var.cluster_id}-rg"
  network_interface_ids = ["${data.azurerm_subscription.current.id}/resourceGroups/${var.cluster_id}-rg/providers/Microsoft.Network/networkInterfaces/${var.cluster_id}-worker${var.index}-nic"]
